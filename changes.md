...
* MELPA requested that the syntax tester files not be included in the
  official package, so I split them into another package. If you really want
...
* Changed indenting routing to be able to use extra indentation for
  continuations inside of functions (specifically for extended `cond()`s.
